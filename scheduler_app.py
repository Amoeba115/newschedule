...
    st.markdown("""Edit the rules for this session here. I promise it's not as complicated as it might look at first lol.
    ...
    You get the point, I'll stop rambling lol.""")    edited_rules = st.text_area(
